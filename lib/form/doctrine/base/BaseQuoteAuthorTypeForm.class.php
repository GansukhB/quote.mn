...
/**
 * QuoteAuthorType form base class.
 *
 * @method QuoteAuthorType getObject() Returns the current form's model object
 *
 * @package    quote.mn
 * @subpackage form
 ...
 */
abstract class BaseQuoteAuthorTypeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('quote_author_type[%s]');
